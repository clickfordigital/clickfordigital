...
export default function Navbar({ darkMode, setDarkMode }: NavbarProps) {
  ...
  // Determine if path matches link
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-50 animate-fade-in">
        <div className="flex items-center justify-between">
          
          {/* Logo / Brand - Links to Home Page Page shell */}
          <Link
            to="/"
            id="nav-logo"
          ...
          <div className="hidden lg:flex items-center gap-8">
                ...
                return (
                  <li key={link.name}>
                    <Link
                      ...
                      className={`font-sans text-sm font-medium transition-colors relative py-1 block ${
                        active
                          ? "text-teal-600 dark:text-teal-400 font-semibold"
                          : "text-zinc-650 dark:text-zinc-300 hover:text-teal-600 dark:hover:text-teal-400"
                      }`}
                    >
                      {link.name}
                      {active && (
            ...
            <div className="h-4 w-[1px] bg-zinc-200 dark:bg-zinc-805"></div>
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="p-2.2 rounded-xl border border-zinc-200 dark:border-zinc-800 text-zinc-650 dark:text-zinc-300 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500/50"
              >
          ...
          <div className="flex lg:hidden items-center gap-2">
            <button
              ...
              aria-label="Toggle visual theme"
              className="p-2 rounded-xl border border-zinc-200 dark:border-zinc-800 text-zinc-650 dark:text-zinc-300 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors shadow-sm focus:outline-none"
            >
            ...
            <button
              ...
              className="p-2 rounded-xl border border-zinc-200 dark:border-zinc-800 text-zinc-650 dark:text-zinc-300 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors focus:outline-none"
            >
                  ...
                  return (
                    <li key={link.name}>
                      <Link
                        ...
                        className={`block px-3 py-2.5 rounded-xl font-sans text-sm font-medium transition-all cursor-pointer select-none ${
                          active
                            ? "bg-teal-50/50 dark:bg-teal-950/20 text-teal-600 dark:text-teal-400 font-semibold"
                            : "text-zinc-650 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-teal-600 dark:hover:text-teal-400"
                        }`}
                      >
                        {link.name}
                      </Link>
